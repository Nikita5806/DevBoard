  ...
  return (
    <div className="min-h-screen bg-black flex items-center justify-center p-4">
      ...
      <div className="fixed top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
        <div className="absolute top-[-20%] left-[-10%] w-[500px] h-[500px] bg-purple-600 rounded-full mix-blend-screen filter blur-[120px] opacity-30"></div>
        <div className="absolute bottom-[-20%] right-[-10%] w-[500px] h-[500px] bg-pink-600 rounded-full mix-blend-screen filter blur-[120px] opacity-30"></div>
      </div>
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 shadow-2xl">
          ...
          <p className="text-gray-500 text-center mt-6 text-sm">
            no account yet?{' '}
            <Link to='/signup' className="text-purple-400 font-bold hover:text-pink-400 transition">
              join for free ✨
            </Link>
          </p>
